...
\frametitle{Motivation}
 \centering	
	  \includegraphics[width=1.0\columnwidth]{Motiv.pdf}
...
%\begin{frame}
%\frametitle{Icing Days}
%\begin{center}
%
%{\includegraphics[width=1.02\textwidth]{risultati/id_Alpine_Models_ts.png}} %{./loginOpen.mp4}
%
%\end{center}
%\end{frame}
%----------------------------------------------------
